      ...
      return(
            <>
                  ...
                  <div className="max-w-5xl m-auto">
                        ...
                        <input type="text" className="w-full mb-4" placeholder="Update username" name="username" onChange={handleForm}/>
                        <h3 className="mb-2">Password</h3>
                        <input type="text" className="w-full mb-4" placeholder="Update password" name="password" onChange={handleForm}/>
                        <button className="bg-blue-500" onClick={handleSubmit}>Update</button>
                  </div>
            </>
      )
}